      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <span className="logo-dot w-7 h-7 rounded-lg bg-gradient-to-br from-[#14B8A6] to-[#0F766E] flex items-center justify-center">
          ...
          <Link href="/contact#snapshot" className="hidden md:inline-flex items-center bg-[#0D9488] text-white text-[13px] font-semibold px-4 py-2.5 rounded-lg hover:bg-[#0F766E] transition cta-pulse">
