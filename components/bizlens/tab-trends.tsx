...
function DirIcon({ dir }: { dir: TrendDirection }) {
  if (dir.dir === 'up') return <TrendingUp className="h-4 w-4 text-teal-500" />;
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {dirCards.map((d) => (
            <div key={d.name} className="p-4 rounded-xl bg-zinc-50 border border-zinc-100 text-center">
              ...
              <div className={`text-2xl font-semibold ${d.dir.dir === 'up' ? 'text-teal-600' : d.dir.dir === 'down' ? 'text-rose-600' : 'text-zinc-500'}`}>
