...
const REPORTS = [
  ...
  {
    href: '/admin/reports/client-services',
  ...
  {
    href: '/admin/reports/pending-billing',
  ...
  {
    href: '/admin/reports/service-wise',
    title: 'Service-wise',
        ...
        {REPORTS.map((report) => {
          ...
          return (
            <Link
              key={report.href}
              href={report.href}
              className="group rounded-2xl bg-white p-6 transition-all duration-200 hover:shadow-md cursor-pointer"
            ...
            >
              ...
              <h3 className="text-base font-semibold text-zinc-900 mt-4 group-hover:text-[#0D9488] transition-colors">
                {report.title}
              </h3>
