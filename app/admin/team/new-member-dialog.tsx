...
export default function NewTeamMemberDialog({ team }: { team: TeamMember[] }) {
  ...
  function reset() {
    setForm({ full_name: '', email: '', password: '', role: 'team', job_title: '', department: '', phone_number: '', manager_id: '' });
  }
