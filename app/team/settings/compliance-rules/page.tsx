...
export default async function ComplianceRulesPage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl">
      <Link href="/team/settings" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-zinc-900">
      ...
      {Object.keys(grouped).length === 0 ? (
        ...
        <section key={kind} className="space-y-3">
          ...
          <div className="tff-card overflow-hidden divide-y" data-testid={`rules-${kind}`}>
            {rs.map((r: any) => (
