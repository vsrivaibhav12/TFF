  ...
  return (
    <div className="tff-stack-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="tff-card p-5"><div className="tff-kpi-value text-teal-600">₹{grandTotalBilled.toLocaleString('en-IN')}</div><div className="tff-kpi-label mt-1">Billed</div></div>
                ...
                <TableBody>
                  {Object.values(svc.subServices).map((ss) => (
                    <TableRow key={ss.code}>
                      ...
                      <TableCell className="text-right tabular-nums text-teal-700">{ss.totalBilled > 0 ? `₹${ss.totalBilled.toLocaleString('en-IN')}` : '—'}</TableCell>
